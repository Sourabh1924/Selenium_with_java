...
public class Mail_script_multiple_iteration {

	//---------------------------------Variables---------------------------------------------
		String testName 		= "Hotmail_send_mail_dataprovider";
		String File_path		= "E:\\Sourabh_Selenium\\Sel\\Hotmail_project\\Project_Data\\HM_Data_sheet_iteration.xls";
		long S_time				= 0;
		long E_time				= 0;
		//---------------------------------------------------------------------------------------
		...
		@Test(dataProvider="Send_Mail_Data",priority=2)
		public void Mail(String To_field,String cc_field,String subject,String content) throws Throwable
			{
				//----------------------------------------------Start report test-------------------------------------------------
				testName	= new Object(){}.getClass().getEnclosingMethod().getName();
				logger 		= Extndreport.startTest(testName);
				...
				//---------------------------------Variables--------------------------------------
				String[] Mail = { To_field, cc_field, subject, content};
		...
		public Object[][] data_provider() throws Throwable
		{
			Object[][] testObjArray = Excel_libraries.Read_Data_itera(File_path, "Send_mail");	
			return testObjArray;
		}
