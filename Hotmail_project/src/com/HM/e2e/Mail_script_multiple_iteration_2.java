...
import com.HM.webelement.DataProviders;
...
public class Mail_script_multiple_iteration_2 {

	//---------------------------------Variables---------------------------------------------
		String testName 		= "Hotmail_send_mail_dataprovider_class";
		...
		@Test(dataProvider="Send_Mail_Data",dataProviderClass = DataProviders.class,priority=2)
